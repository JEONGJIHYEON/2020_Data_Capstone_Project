...
![image](https://user-images.githubusercontent.com/50713190/102577752-fee18300-413b-11eb-82cf-02dbe9590c8f.png)
- 하나의 직선에 점들이 모여있을수록 예측이 잘 되었다고 볼 수 있다.
- RMSE (평균 제곱근 오차) = 8525874699.94858. 이 값이 작을수록 모델의 예측력이 높다. 그러나 종속 변수인 '총 매출'의 데이터 자체가 원래 큰 값임을 고려하면 판단이 어려울 수 있다.
- 상관 계수 R = -0.04555113875469926. 결정 계수 R²의 값이 클수록 모델의 예측력이 높다. 즉, 이 모델은 뭐로 보나 예측력이 높다고 할 수 없다.
- Relative Error (상대 오차)
![image](https://user-images.githubusercontent.com/50713190/102580019-140ce080-4141-11eb-90c4-f327d811b6bf.png)
